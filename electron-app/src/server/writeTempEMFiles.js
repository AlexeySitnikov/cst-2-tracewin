...
const write3DEM = require('./write3DEM')

const writeTempEMFiles = (file, index, tempDirectory, webSocketServer) => (
  new Promise((resolve) => {
    ...
    rl.on('line', (line) => {
      if (lineIndex >= file.linesToBeDeleted) {
        ...
        write3DEM(writerEx, writerEy, writerEz, line)
      } else {
        lineIndex += 1
      }
    })
...
module.exports = writeTempEMFiles
